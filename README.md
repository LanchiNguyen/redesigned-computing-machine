...
- **`v2/`** — includes **Morsel** (`v2/morsel.html`, № 02): a photo-first food-discovery concept built from the uploaded case-study package — three prototype versions, 30 designed states, wireflow/explorations/DS/testing-plan artifacts (linked live in `v2/morsel-docs/`), all research honestly labeled as not-yet-run. Assets in `images/morsel/`.
